 ...
 */
public class BasicHeadwordSearchFragment extends Fragment {
    ...
    public BasicHeadwordSearchFragment() {
...
dataProvider.ClearList();
    ...
    private void loadNextData(int page) {
        dataProvider.searchHeadwordByCriteria(new HeadwordListResponseObserver(), page * 20, 20, false);

    }

    private void loadNextData(int page, boolean up) {
        dataProvider.searchHeadwordByCriteria(new HeadwordListResponseObserver(swipeContainer), page * 20, 20, false);
    }
}
